...
def importApp(foldername):
    ...
    filename = str(foldername)+'/progen_mass.txt'
    data0 = []
    delimiters = []
    i = 0
    ...
    # Generate initial numpy array from txt file
    filename = str(foldername)+'/progen_sfr.txt'
    data0 = []
    delimiters = []
    i = 0
    j = 0
    ...
    # Generate initial numpy array from txt file
    filename = str(foldername)+'/progen_fgas.txt'
    data0 = []
    delimiters = []
    i = 0
    j = 0
    ...
    # Generate initial numpy array from txt file
    filename = str(foldername)+'/progen_h1_gal.txt'
    data0 = []
    delimiters = []
    i = 0
    j = 0
    ...
    # Generate initial numpy array from txt file
    filename = str(foldername)+'/progen_h2_gal.txt'
    data0 = []
    delimiters = []
    i = 0
    j = 0
    ...
    # Generate initial numpy array from txt file
    filename = str(foldername)+'/progen_z.txt'
    data0 = []
    delimiters = []
    i = 0
    j = 0
    ...
    # Generate initial numpy array from txt file
    filename = str(foldername)+'/progen_sfe.txt'
    data0 = []
    delimiters = []
    i = 0
    j = 0
...
# Generate initial numpy array from txt file
    filename = str(foldername)+'/progen_gal_type.txt'
    data0 = []
    delimiters = []
    i = 0
    j = 0
