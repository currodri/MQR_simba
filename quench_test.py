...
for i in range(0, len(thubble_start)):
    ax1.plot([thubble_start[i],thubble_start[i]],[-13.0,-7.6], linestyle=':', color='b')
    ax1.plot([thubble_end[i],thubble_end[i]],[-13.0,-7.6], linestyle=':', color='r')
